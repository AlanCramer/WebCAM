...
(function() {
    ...
    ACTP.gCodeRoughPass = function(arrayOfPaths, depthPerPass, pxPerMm) {
    ...
    ACTP.gCodePaths = function(paths, pxPerMm) {
    ...
    ACTP.gCodeJogPoints = function(jogHeight, cutDepth, pt, pxPerMm) {
    ...
    ACTP.gCodeTakeDown = function (finalHeight) {
    ...
    ACTP.gCodeSetUp = function(feedrateInPerMin) {
